    ...
    dark: [
        {
            ...
            description:
                'We care about you and prioritize listening to your needs at the heart of our practice. Our services are designed to fit your changing needs, spanning prevention, early detection, conventional treatments, and cutting-edge therapies. We aim to bridge the gap between what is available and what is possible.',
            // buttonLink: '/compassionate-use'
        },
        {
            title: 'Highest Level of Personalized Care',
            description:
                "Our care team members strive to provide the highest level of personalized care fit for each person's needs. <br><br> We are knowledge-driven and passionate about research and discoveries, leveraging cutting-edge approaches to provide you with the best possible health outcomes.",
        },
    ],
    grey: [
        {
            ...
            description:
                'Better cancer care and improved wellness outcomes through deep relationships and ongoing conversations during your shared cancer prevention and care journey with your concierge physician.',
        },
        {
            title: 'Care that is Highly Personal and Exceptional',
            description:
                'Next Level Oncology is based on the premise that delivering exceptional medical care must fundamentally revolve around, honor and protect the most scared of relationship - the one between a physician and a patient.',
        },
        {
    ...
    white: [
        {
            ...
            description:
                'Maintaining confidentiality and providing all services with the utmost discretion is central to our practice and one of its core values',
            isCentered: true,
        },
        {
        ...
        cards: [
            {
                ...
                description:
                    'Personalized cancer care with unmatched expertise and attention to detail throughout your journey',
            },
            {
                image: 'wellness',
                header: 'Prevention and Wellness',
                description:
                    'Advanced diagnostics and preventative care tailored to optimize your health and longevity',
            },
            {
                image: 'support',
                header: 'Integrative Family Care',
                description:
                    'Comprehensive care adapting to the evolving needs of each family member, from prevention to treatment',
            },
        ],
    },
};
export const compassionateInfo = {
	...
	dark: [
		{
			title: 'At Next Level Oncology, no treatment option, specialist, or location is off limits for our clients'
		}
	],
	grey: [
		{
			title: 'Your Personalized Pathway to Hope and Life',
			description: 'Next Level Oncology bridges the gap between what is available and what is possible. Our expertise turns hope into reality.'
		}
	],
	white: [],
	cardsSection: {

export const founderInfo = {
	...
	white: [
		...
		{
			title: 'The path to medicine',
			description: 'Just as Dr Csiki began her MD/PhD studies, her grandfather was diagnosed with very advanced colorectal cancer. He passed away a few months after the diagnosis in 2001, never having received any treatment for the cancer due to his advanced illness and medical practice limitations of that time. Dr Csiki spent the remaining time of his life caring for him. His death in August 2001 left profound sadness but also determination to dedicate her career to advancing cancer research and enable patients the choice and opportunity to access therapies that can help live a better life. Furthermore, Dr Csiki wanted to ensure that patients receive the type of access and personal care she would have wanted her grandfather to receive from her doctor. <br><br>She completed her MD and the PhD in the field of Cancer Biology at Vanderbilt University, pursuing innovative research and later specialized in the care of cancer patients. It was this relentless pursuit of combining innovative cancer research with the best patient care and therapeutics available that got her excited to accept a faculty position at the University of Pennsylvania where she continued to focus on cancer research and care of cancer patients. She took on clinical research positions at the top oncology companies including Merck and led development of novel drugs such as the immunotherapy, Keytruda. After an exciting career on the East Coast,  Dr Csiki was recruited to City of Hope in Southern California to continue advancing cancer research and care of patients. She helped patients get access to innovative, novel medicines from biotechs when no further therapy was available yet patients wanted to continue to fight. Through this process she became intimately familiar with the compassionate use program that patients can participate in and helped other physicians navigate this process.'
		},
		{
			title: 'Personal medical attention',
			description: 'The combination of personal experiences and professional experiences of working with cancer patients for over 20 years and trying to overcome the limitations of even the best hospitals to offer the most comprehensive and caring experience to the patient and family, led Dr Csiki to found the first true oncology concierge practice in Southern California or anywhere. <br><br> We were compelled to start Next Level Oncology for family members like the founder’s grandfather as we envision providing the same type of care and personal medical attention we believe our loved ones should receive.',
			img: 'personal.webp'
		}
	]
